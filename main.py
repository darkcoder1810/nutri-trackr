...
def show_user_info_modal():
    with st.form("user_info_form"):
        ...
        weight = st.number_input("Weight (kg)", min_value=30.0, max_value=200.0, value=float(st.session_state.user_info.get('weight', 70.0)))
        ...
        protein_per_kg = st.slider("Protein (g) per kg", 1.6, 3.0, float(st.session_state.user_info.get('protein_per_kg', 2.0)))
